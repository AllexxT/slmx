"""
Django settings for silmix project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'frontend.processors.frontend_processor',
...
WSGI_APPLICATION = 'silmix.wsgi.application'
...
# MEDIA_ROOT = os.path.join(BASE_DIR).replace('tsite', 'media')
